...
namespace Ezzoo {
	...
	void OpenGLFrameBuffer::Invalidate()
	{
		...
		{
			EZZOO_CORE_ASSERT(m_ColorAttachments.size() <= 4, "Color attached is Wrong");
		...
		EZZOO_CORE_ASSERT(glCheckFramebufferStatus(GL_FRAMEBUFFER) == GL_FRAMEBUFFER_COMPLETE, "Framebuffer is incomplete!");
